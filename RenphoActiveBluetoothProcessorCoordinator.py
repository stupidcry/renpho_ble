...
class RenphoActiveBluetoothProcessorCoordinator(ActiveBluetoothProcessorCoordinator):
    ...
    def __init__(
        ...
        *,
        ...
        device_data: RenphoBluetoothDeviceData,
...
class RenphoPassiveBluetoothDataProcessor(PassiveBluetoothDataProcessor):
    """Define a Xiaomi Bluetooth Passive Update Data Processor."""

    coordinator: RenphoActiveBluetoothProcessorCoordinator
